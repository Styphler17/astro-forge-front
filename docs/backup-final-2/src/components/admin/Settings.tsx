...
const Settings = () => {
      ...
      siteSettings.forEach((setting: { setting_key: string; setting_value: string }) => {
        ...
        switch (setting.setting_key) {
          ...
          case 'contact_address':
            ...
            break;
          case 'footer_text':
            mappedSettings.footerText = value;
            break;
          case 'social_links':
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await apiClient.updateSiteSetting('footer_text', settings.footerText, 'string');
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              rows={2}
              placeholder="© 2024 Astro Forge Holdings. All rights reserved."
            />
          </div>
        </CardContent>
      </Card>
