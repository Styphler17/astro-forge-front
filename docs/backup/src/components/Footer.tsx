      ...
      try {
        ...
        const settingsMap = settings.reduce((acc: SettingsMap, setting: SiteSetting) => {
          try {
            ...
            const value = setting.setting_type === 'json' 
          ...
          <div>
            <div className="flex items-center mb-4">
              <div className="bg-white p-2 rounded-lg shadow-sm">
                <img 
                  src={companyInfo?.logo_url || "/astroforge-uploads/AstroForgeHoldings-Logo.png"} 
            ...
            <p className="text-gray-300 font-roboto leading-relaxed mb-6">
              {companyInfo?.description || "Building tomorrow's infrastructure through innovation, sustainability, and strategic investment across multiple sectors."}
            </p>
